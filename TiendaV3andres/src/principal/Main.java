...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //Torres de prueba
        la_tienda.("Corsair iCUE 7000X RGB", 410, 80, 20, 'T', "Corsair");
        la_tienda.("SilverStone ML04B", 108, 45, 5, 't', "SilverStone");
        la_tienda.("Thermaltake Tower 100 Mini Torre", 120, 50, 10, 'm', "Thermaltake");
        la_tienda.("Caja servidor Lanberg", 100, 40, 9, 'b', "Lanberg");
        la_tienda.("Aerocool Genesis ARGB", 80, 40, 4, 's', "Aerocool");
        ...
        do {
            ...
            }catch(TiendaException tienda_exc){
                System.out.println(tienda_exc.getMessage());
            }
